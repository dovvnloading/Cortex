...
> **Project-plan correction (2026-07-29):** The concise [open-source execution plan](../archive/OPEN_SOURCE_EXECUTION_PLAN.md)
...
phase; use [the open-source execution plan](../archive/OPEN_SOURCE_EXECUTION_PLAN.md) for
remaining work.
