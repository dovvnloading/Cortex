...
class Orchestrator:
    ...
    def clear_all_chat_history(self):
        """
        Deletes all chat history files and resets the application to a new chat state.
        """
        self.chat_history_manager.clear_all_history()
        self.start_new_chat() # Reset the orchestrator state to a fresh chat
...
def main():
    ...
    icon_path = r"C:\Users\Admin\source\repos\Chat_LLM\assets\icon.ico"
