...
class PromptTemplate:
    ...
    def build_synthesis_prompt(query: str, chat_history: str, permanent_memories: list[str], memories_enabled: bool) -> list[dict]:
        ...
        """
        system_content = """You are Cortex, a helpful AI assistant. Respond to the user's query clearly and concisely. Use the provided conversation history to maintain context. Use Markdown for formatting when it improves readability."""
